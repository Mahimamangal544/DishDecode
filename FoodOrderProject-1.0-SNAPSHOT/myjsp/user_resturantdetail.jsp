...
<html>
    ...
    <body>
        ...
        <a href="user_resturant.jsp" class="back-btn">⬅ Back</a>
        ...
        <%
            try {
                ...
                String q1
                        = "SELECT fooditem.FoodItem_Name, fooditem.FoodItem_Type, "
        ...
        <div class="restaurant-grid">
            ...
            <div class="restaurant-box">
                ...
                <div class="rest-info">
                    ...
                    <a href="user_fooddetail.jsp?name=<%= rs.getString("FoodItem_Name")%>">
